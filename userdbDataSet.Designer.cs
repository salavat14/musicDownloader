...
namespace MusicDownloader {
    ...
    public partial class userdbDataSet : global::System.Data.DataSet {
        ...
        public partial class SongsDataTable : global::System.Data.TypedTableBase<SongsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public SongsRow AddSongsRow(string Name, int Time) {
        ...
        public partial class SongsRow : global::System.Data.DataRow {
            ...
            public int Time {
                get {
                    try {
                        return ((int)(this[this.tableSongs.TimeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Time\' в таблице \'Songs\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsTimeNull() {
                return this.IsNull(this.tableSongs.TimeColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetTimeNull() {
                this[this.tableSongs.TimeColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace MusicDownloader.userdbDataSetTableAdapters {
    ...
    public partial class SongsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Songs] WHERE (([Id] = @Original_Id) AND ((@IsNull_Time = 1 AND" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Songs] ([Name], [Time]) VALUES (@Name, @Time);\r\nSELECT Id, Nam" +
                "e, Time FROM Songs WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Songs] SET [Name] = @Name, [Time] = @Time WHERE (([Id] = @Original_" +
                "Id) AND ((@IsNull_Time = 1 AND [Time] IS NULL) OR ([Time] = @Original_Time)));\r\n" +
                "SELECT Id, Name, Time FROM Songs WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::MusicDownloader.Properties.Settings.Default.userdbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Time FROM dbo.Songs";
        ...
        public virtual int Fill(userdbDataSet.SongsDataTable dataTable) {
        ...
        public virtual userdbDataSet.SongsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            userdbDataSet.SongsDataTable dataTable = new userdbDataSet.SongsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(userdbDataSet.SongsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, global::System.Nullable<int> Original_Time) {
        ...
        public virtual int Insert(string Name, global::System.Nullable<int> Time) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, global::System.Nullable<int> Time, int Original_Id, global::System.Nullable<int> Original_Time, int Id) {
            if ((Name == null)) {
            ...
            if ((Original_Time.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_Time.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, global::System.Nullable<int> Time, int Original_Id, global::System.Nullable<int> Original_Time) {
            return this.Update(Name, Time, Original_Id, Original_Time, Original_Id);
        }
    }
